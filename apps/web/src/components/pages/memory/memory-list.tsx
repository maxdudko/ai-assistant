  ...
  return (
    <div className="flex h-full flex-col">
      <div className="mb-4 flex items-center justify-between">
        ...
        <Button type="button" onClick={loadMemories} content="Refresh" />
      </div>
          ...
          <div className="space-y-3">
            {memories.map(memory => (
              <Container key={memory.id}>
                <div className="rounded-lg border border-neutral-800 bg-neutral-900 p-4 transition-colors hover:border-neutral-700 hover:bg-neutral-800">
